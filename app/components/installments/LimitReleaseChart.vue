...
<template>
  <div class="flex flex-col h-full">
    <div class="flex items-center gap-2 mb-6">
      <div class="p-2 bg-primary/12 border border-primary/30 rounded-lg transition-all duration-200 hover:scale-105">
      ...
      <svg :viewBox="`0 0 ${width} ${height}`" class="w-full h-full overflow-visible">
        ...
        <g v-for="d in (data as any[])" :key="d.label">
          <rect
            ...
            class="fill-primary/80 hover:fill-primary transition-all duration-300 rounded"
            rx="4"
          />
