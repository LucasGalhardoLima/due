...
<template>
  <div class="rounded-2xl border bg-card p-6 shadow-elevation-2 relative overflow-hidden group">
      <!-- Background Flair -->
      <div 
      ...
      <div v-if="alert.type === 'future_shortage'" class="space-y-6 relative z-10">
          ...
          <div class="bg-muted/30 rounded-xl p-4 border border-dashed">
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
              ...
              >
                  ...
                  <div class="mt-2 flex items-center gap-2">
                      ...
                      <span class="text-[10px] text-emerald-600 font-medium">{{ alert.prevention?.option_1?.impact }}</span>
                  </div>
              </div>
              <div 
              ...
              >
                  ...
                  <div class="mt-2 flex items-center gap-2">
                      ...
                      <span class="text-[10px] text-emerald-600 font-medium">{{ alert.prevention?.option_2?.impact }}</span>
                  </div>
              </div>
           </div>
      </div>
      ...
      <div v-else class="space-y-6 relative z-10">
           ...
           <div class="bg-destructive/10 rounded-xl p-4 border border-destructive/20">
