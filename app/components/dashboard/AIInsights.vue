...
<template>
  <div class="contents">
      ...
      <Card
        class="relative overflow-hidden group transition-all duration-500 border-ai-accent/30 bg-violet-50 dark:bg-violet-950/30 cursor-pointer hover:bg-violet-100 dark:hover:bg-violet-950/50 active:scale-[0.98]"
      ...
      >
        ...
        <div class="absolute -left-20 -bottom-20 w-48 h-48 bg-violet-500/5 rounded-full blur-[60px] pointer-events-none group-hover:scale-110 transition-transform duration-1000" />
        ...
        <div class="p-5 md:p-6 relative z-10 flex flex-col gap-4 text-left">
           ...
           <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2.5">
                <div class="h-9 w-9 rounded-lg bg-ai-accent/20 flex items-center justify-center text-ai-accent shadow-elevation-1 ring-1 ring-ai-accent/30">
           ...
           <Button
            size="default"
            class="w-full font-bold h-10 rounded-lg bg-ai-accent text-ai-accent-foreground hover:bg-ai-accent/90 transition-all pointer-events-none"
           >
            Abrir Consultor
           </Button>
        </div>
